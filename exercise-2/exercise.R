...
made.in.1997 <- filter(vehicles, year == 1997)
...
made.in.1997 <- arrange(made.in.1997, hwy)
...
made.in.1997 <- mutate(made.in.1997, average = (hwy +cty) / 2)
View(made.in.1997)
...
# and returns tehe vehicle that gets the most hwy miles/gallon of vehicles of that make in that year
